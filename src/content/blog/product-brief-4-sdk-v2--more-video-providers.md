...
We are happy to introduce the [SDK 2.0](/docs/sdk-legacy/getting-started/overview), the easiest way to add link previews in your website without effort.

The version 2.0 introduce a breaking change: It removes the `round` property from the [API Parameters](/docs/sdk-legacy/getting-started/overview) that you can pass for customize the card preview.

The property `round` was related with apply a `border-radius` around your preview card.

We decide make this little change in order the reduce the number of configurable [API Parameters](/docs/sdk-legacy/getting-started/overview).
...
Using [@microlink/react](/docs/sdk-legacy/integrations/react/) just pass your custom CSS as `style` property:
...
Read more about [styling](/docs/sdk-legacy/integrations/react/#styling) in documentation.
