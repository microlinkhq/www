...
The vanilla bundle is based on the [React](/docs/sdk-legacy/integrations/react) version and exported as Universal Module Definition (_UMD_).
...
You can pass any [Microlink API](/docs/api/getting-started/overview) query parameter as an object property, e.g., [size](/docs/sdk-legacy/parameters/size/).
...
Although it's shipped with default styles, you can customize it using [CSS variables](https://microlink.io/docs/sdk-legacy/getting-started/styling#css-variables) or [CSS classes](/docs/sdk-legacy/getting-started/styling#css-classes).
