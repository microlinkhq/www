...
A root `div` used in [Vanilla](/docs/sdk-legacy/integrations/vanilla) to render the virtual DOM.

- **microlink_vue** <br/>
A root `div` used in [Vue](/docs/sdk-legacy/integrations/vue) to render the virtual DOM.
