...
description: 'Use Microlink API to fetch, render, and return HTML from any public URL, either as JSON or as a direct HTML response.'
---
...
Use <Link href='/docs/guides/data-extraction/page-preparation' children='Data extraction: Page preparation' /> for waits, clicks, scrolling, browser settings, and CSS cleanup. Use <Link href='/docs/guides/content-conversion/pdf-url-to-html' children='Convert a PDF URL to HTML' /> when the source URL is a PDF.
