...
Use [attr](/docs/sdk/methods/extract/attr) with `markdown` to serialize any URL as Markdown. This is the direct recipe for LLM ingestion, RAG pipelines, docs imports, and any workflow that should not carry raw HTML.
...
<Figcaption>Use <code>main</code>, <code>article</code>, or a page-specific [selector](/docs/sdk/methods/extract/selector) when the full page is too noisy.</Figcaption>
