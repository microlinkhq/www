---
title: 'Private pages'
description: 'Extract Markdown from pages behind logins, sessions, or header-based personalization. Learn when to use headers, how to pass secrets safely, and when the Pro endpoint is required.'
---
...
Extracting Markdown from private dashboards, localized experiences, or staged environments is possible, but the setup depends on whether the values you need to send are public or sensitive.
...
Do not expose API keys, cookies, or authorization headers in client-side code or public direct-response URLs.
...
This is especially important when you combine extraction with `embed=content`, because the final URL can end up in markup, logs, browser devtools, or shared links.
...
For timeout errors, wrong endpoint issues, or antibot failures such as `EPROXYNEEDED`, continue with [troubleshooting](/docs/guides/markdown/troubleshooting).

## Next step

Learn how to debug empty output, timeout errors, and blocked sites in [troubleshooting](/docs/guides/markdown/troubleshooting).
