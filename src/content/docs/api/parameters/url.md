...
Using the [SDK](/docs/sdk/getting-started/overview), [MQL](/docs/sdk/mql/getting-started/overview), or the [Microlink CLI](/docs/api/getting-started/cli) will escape the URL properly. Otherwise, you need to escape it using [encodeURIComponent](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent) or equivalent.
