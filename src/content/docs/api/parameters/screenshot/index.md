...
You can configure different specific options, such as [element](/docs/api/parameters/screenshot/element), [quality](/docs/api/parameters/screenshot/quality), or [overlay](/docs/api/parameters/screenshot/overlay), or record a short video instead of a static image with [animated](/docs/api/parameters/screenshot/animated):
