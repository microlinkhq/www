...
<MultiCodeEditorInteractive mqlCode={{ url: 'https://stripe.com', screenshot: { animated: true } }} />
...
<MultiCodeEditorInteractive mqlCode={{ url: 'https://stripe.com', screenshot: { animated: { duration: '8s', fps: 30 } } }} />
