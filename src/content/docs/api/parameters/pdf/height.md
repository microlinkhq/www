---
title: 'pdf height'
description: Set a custom paper height for your PDF generation using pixels, inches, or other CSS units. Fine-tune the dimensions of your website-to-PDF conversions with the Microlink API height parameter.
---
