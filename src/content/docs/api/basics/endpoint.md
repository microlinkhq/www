---
title: 'Endpoint'
description: 'Access Microlink API via free and pro endpoints. Learn how to perform HTTP GET requests, use camelCase or snake_case query parameters, and automate endpoint selection using the SDK.'
---
