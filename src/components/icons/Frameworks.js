...
export default props => (
  ...
  >
    ...
    <rect x='152.78' y='215.47' width='252.39' height='238.98' fill='#654ea3' />
    <path
    ...
    <rect x='20.56' y='11.85' width='342.46' height='136.56' fill='#654ea3' />
    <path
    ...
    <rect x='472.23' y='16.73' width='182.89' height='182.89' fill='#654ea3' />
    <path
    ...
    <rect x='513.68' y='271.55' width='252.39' height='182.89' fill='#654ea3' />
    <path
    ...
    <rect x='222.21' y='586.85' width='31.31' height='5.87' fill='#654ea3' />
    <rect x='222.21' y='670.99' width='31.31' height='5.87' fill='#654ea3' />
    <rect x='245.69' y='569.24' width='7.83' height='124.26' opacity='0.1' />
    <rect x='255.47' y='569.24' width='31.31' height='124.26' fill='#535461' />
    <rect x='255.47' y='586.85' width='31.31' height='5.87' fill='#654ea3' />
    <rect x='255.47' y='670.99' width='31.31' height='5.87' fill='#654ea3' />
