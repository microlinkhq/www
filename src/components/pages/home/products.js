...
const FileIcon = ({ format, tint, tintWidth, ...props }) => (
  ...
  >
    ...
    />
    <rect width={tintWidth} height='16' x='1' y='18' fill={tint} rx='2' />
    <path fill={tone.white} d={FILE_GLYPHS[format]} />
  </svg>
)

const CONVERT_INPUTS = [
  { name: 'document.pdf', format: 'pdf', tint: '#D92D20', tintWidth: 26 },
  { name: 'report.xlsx', format: 'xlsx', tint: '#079455', tintWidth: 33 },
  { name: 'guide.docx', format: 'docx', tint: '#155EEF', tintWidth: 36 },
  { name: 'slides.pptx', format: 'pptx', tint: '#E62E05', tintWidth: 33 }
]
