// Single source of truth for the /logo/<lang> landing pages.
//
...
export const LANG_LANDINGS = [
  { lang: 'nodejs', label: 'Node.js', href: '/logo/nodejs' },
  { lang: 'python', label: 'Python', href: '/logo/python' },
  { lang: 'php', label: 'PHP', href: '/logo/php' },
  { lang: 'ruby', label: 'Ruby', href: '/logo/ruby' },
  { lang: 'go', label: 'Go', href: '/logo/go' }
]
