  ...
  <Layout>
    ...
    >
      ...
      <Text css={theme({ maxWidth: layout.small, marginTop: 4 })}>
        We prioritize <strong>developer-to-developer interaction</strong>,
        ensuring you get technical, code-level assistance rather than generic
        automated responses.
      </Text>

      <Text css={theme({ maxWidth: layout.small, marginTop: 4 })}>
        Whether you are debugging a complex Puppeteer integration, optimizing
        concurrency, or want to propose a new feature for our roadmap, our
        channels are <strong>open and free</strong>. It's the fastest way to get
        your project moving.
      </Text>
