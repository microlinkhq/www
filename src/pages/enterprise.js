...
- Your own Microlink API endpoint, with your own dedicated pool of always-ready browsers.
- Your own S3-like storage service for assets, with no time-to-live (TTL) restriction.
- Your own CDN distribution (+200 nodes over the world, powered by CloudFlare).
...
The price model is the same, plus 500€ for the extra cost of keeping the dedicated infrastructure running.`.trim()
    ...
    <DotsBackground theme={theme}>
      <Layout theme={theme} footer={{ bg: 'transparent' }}>
        ...
        >
          ...
          <Box pt={[3, 3, 4, 4]} color={secondary}>
