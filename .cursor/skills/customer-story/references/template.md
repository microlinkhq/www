...
Canonical template for `src/pages/use-cases/customers/<slug>.js` (route
`/use-cases/customers/<slug>`). Mirrors `src/pages/use-cases/customers/luckynote.js`. The page still imports from the **CustomerStory** module —
